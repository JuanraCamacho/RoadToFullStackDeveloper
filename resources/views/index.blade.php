        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="active">
                    <a href="{{ route('index') }}"><span class="fa fa-desktop"></span> <span class="xn-text">Inicio</span></a>                        
                    </li>                    
                    <li class="xn-openable">
                        <a href="#"><span class="fa fa-files-o"></span> <span class="xn-text">Áreas</span></a>
                        <ul>
                            <li class="xn-openable">
                                <a href="#"><span class="fa fa-clock-o"></span> Temas</a>
                                <ul>
                                    <li><a href="{{ route('cursos') }}"><span class="fa fa-image"></span> Cursos</a></li>
                                    <li><a href="{{ route('recursos') }}"><span class="fa fa-user"></span> Recursos</a></li>
                                </ul>
                            </li>
